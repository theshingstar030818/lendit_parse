...
/**
 * Generated class for the RentalDetailsActivePage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-rental-details-active',
  templateUrl: 'rental-details-active.html',
})
export class RentalDetailsActivePage {
