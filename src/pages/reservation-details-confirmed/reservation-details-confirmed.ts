...
/**
 * Generated class for the ReservationDetailsConfirmedPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-reservation-details-confirmed',
  templateUrl: 'reservation-details-confirmed.html',
})
export class ReservationDetailsConfirmedPage {
