...
/**
 * Generated class for the ItemBookingSchedulePage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-item-booking-schedule',
  templateUrl: 'item-booking-schedule.html',
})
export class ItemBookingSchedulePage {

  pageTitle = "Item Booking Schedule";
  public request : any = {};
  public item: any;
  public rateType: any;
