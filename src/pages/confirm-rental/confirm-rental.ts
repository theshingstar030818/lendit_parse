...
/**
 * Generated class for the ConfirmRentalPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-confirm-rental',
  templateUrl: 'confirm-rental.html',
})
export class ConfirmRentalPage {

  pageTitle = "Rental Request Confirmation";
  public request : any = {};
  public item: any;
  public rateType: any;
