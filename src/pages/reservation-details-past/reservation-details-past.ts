...
/**
 * Generated class for the ReservationDetailsPastPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-reservation-details-past',
  templateUrl: 'reservation-details-past.html',
})
export class ReservationDetailsPastPage {
