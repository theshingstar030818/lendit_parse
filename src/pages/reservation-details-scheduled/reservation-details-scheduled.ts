...
/**
 * Generated class for the ReservationDetailsScheduledPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-reservation-details-scheduled',
  templateUrl: 'reservation-details-scheduled.html',
})
export class ReservationDetailsScheduledPage {
